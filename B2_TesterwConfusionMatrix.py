...
def testFiles(fileList,correctAnswer):
	...
	for file in fileList:
		...
		prediction = myModel.predict_classes(Xarray)[0]; trueYs.append(correctAnswer); predYs.append(prediction)
...
for myClass in ["black","brown","blue","green","grey"]:
	eyeFiles=(glob.glob("/Users/faymita29/Downloads/Datasets/B2/test/"+myClass+"/*.png"))
	#print(eyeFiles)
